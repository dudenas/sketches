...
function draw() {
  ...
  if (bTransformingFromCircleToTriangle) {
    ...
    // square
    if ((deleteAtIndex == (2 * npointsInit / 4)) || (deleteAtIndex == (npointsInit / 4)) || (deleteAtIndex == 0) || deleteAtIndex == (3 * npointsInit / 4)) {
      deleteAtIndex--;
    }
...
function mousePressed() {
  if (bTransformingFromCircleToTriangle || (xpoints.length == 4)) {
    bTransformingFromCircleToTriangle = false;
    initialize();
  } else {
    bTransformingFromCircleToTriangle = true;
